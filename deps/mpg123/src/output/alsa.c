...
#define BUFFER_LENGTH 0.2	/* in seconds (croquet: was 0.5 in the original package, but we want to make sure that changes in gain come through quickly) */
...
printf("ms_since_trigger: %ld", ms_since_trigger);
